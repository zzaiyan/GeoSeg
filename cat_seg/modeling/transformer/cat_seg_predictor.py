...
class CATSegPredictor(nn.Module):
    ...
    def forward(self, x, vis_guidance, depth_feat, depth_decoder_guidance, prompt=None, gt_cls=None):
        ...
        out = self.transformer(x, text, vis, depth_feat, depth_decoder_guidance)
        return out
